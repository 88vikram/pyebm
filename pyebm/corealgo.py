...
def Reject(data_AD,data_CN):
    ...
    import numpy as np
    from pyebm.mixture_model import calculate_prob_mmN
    from pyebm.mixture_model import calculate_prob_mm
...
def GMM(Data,Nfeats,params,bnds):
        from pyebm.mixture_model import calculate_likelihood_gmmN
        from pyebm.mixture_model import calculate_likelihood_gmm
